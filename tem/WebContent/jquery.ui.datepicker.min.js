...
e) {
	...
	t.fn.extend( {
		...
		zIndex:function(i) {
			...
			if (this.length) for (var s, n, o=t(this[0]);
	...
	t("<a>").data("a-b",
	"a").removeData("a-b").data("a-b") && (t.fn.removeData=function(e) {
		return function(i) {
	...
	t.extend(t.ui,
	{
		plugin: {
			...
			i) {
				var s, n=t.plugins[e];
				if (n && t.element[0].parentNode && 11 !==t.element[0].parentNode.nodeType) for (s=0;
				n.length > s;
				s++) t.options[n[s][0]] && n[s][1].apply(t.element, i)
			}
		}
		,
